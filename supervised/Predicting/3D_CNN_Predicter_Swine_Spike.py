...
path = '../counting/'
path1 = '../data/'
model_name = './DCR_CNN_model_Spike.txt'
...
for file in os.listdir(path):
    if file.startswith ('df_full_DCR_counting_S_ORF1ab_Coronaviridae(Organism)_26-32k_2564_CDS_S_host_2_SARS2.csv')&file.endswith('.csv'):
        print (file)
        ...
        print (res.shape)
        file_name = 'df_predicted_Swine_Spike' + model_name[2:-4] + '.csv'
