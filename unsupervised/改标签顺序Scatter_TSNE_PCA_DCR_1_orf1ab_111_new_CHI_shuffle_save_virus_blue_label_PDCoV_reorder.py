...
df0_CoVs_ORF_training_sui = pd.read_csv ('data_TSNE_PCA_post_sampling_ORF1ab_reorder.csv')
...
#            plt.ylim([-0.1,1.1])
            ...
            sns.set_style("white")
#             plt.legend(scatterpoints=1)
        plt.savefig('sns_scatterplot_tSNE_PCA_ORF1ab_' + set_name + '_sampling200_test_sui_virus_blue_label_PDCoV_reorder.png', dpi = 300, bbox_inches = 'tight')
