...
df0_CoVs_Chiroptera0 = df0_CoVs1 [(df0_CoVs1 ['host']=='Chiroptera')]
print (df0_CoVs_Chiroptera0.shape)
df0_CoVs_Chiroptera0['adaptation'] = [1]*df0_CoVs_Chiroptera0.shape[0]
print (df0_CoVs_Chiroptera0.shape)
 
df0_CoVs_Chiroptera1 = df0_CoVs1 [(df0_CoVs1 ['host']=='Chiroptera_1')].sample (frac = 0.30, random_state = 10)
print (df0_CoVs_Chiroptera1.shape)
df0_CoVs_Chiroptera1['adaptation'] = [1]*df0_CoVs_Chiroptera1.shape[0]
print (df0_CoVs_Chiroptera1.shape)
...
df0_CoVs_Artiodactyla['adaptation'] = [3]*df0_CoVs_Artiodactyla.shape[0]
print (df0_CoVs_Artiodactyla.shape)
...
df0_CoVs_Suiformes['adaptation'] = [6]*df0_CoVs_Suiformes.shape[0]
print (df0_CoVs_Suiformes.shape)
 
df0_CoVs_all = pd.concat ([df0_CoVs_Chiroptera, df0_CoVs_Rodent_Lagomorpha, df0_CoVs_Artiodactyla, df0_CoVs_Carnivora, df0_CoVs_Primates, df0_CoVs_Suiformes], axis = 0)#连接参数产生的字符串
