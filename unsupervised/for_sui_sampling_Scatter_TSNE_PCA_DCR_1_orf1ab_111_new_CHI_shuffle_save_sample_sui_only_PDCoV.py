...
df_CoVs_ORF_sui = pd.read_csv ('../data/df_full_DCR_counting_ORF1ab.csv')
...
df0_CoVs_ORF_training_sui.to_csv ('shuffle_save_sui_PDCoV.csv')
df0_CoVs_ORF_training_sui = pd.read_csv ('shuffle_save_sui_PDCoV.csv')
