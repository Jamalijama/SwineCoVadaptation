...
df_CoVs_ORF = pd.read_csv ('../data/df_full_DCR_counting_Spike.csv')
...
df0_CoVs_ORF_training.to_csv ('shuffle_save_virus_spike.csv')
df0_CoVs_ORF_training = pd.read_csv ('shuffle_save_virus_spike.csv')
...
SMOTE_train_x.to_csv ('SMOTE_train_x_1_spike.csv')
SMOTE_train_y.to_csv ('SMOTE_train_y_1_spike.csv')
